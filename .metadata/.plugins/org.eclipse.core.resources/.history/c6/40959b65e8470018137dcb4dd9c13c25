...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
    	int grayAverage=((pixelObj.getRed())+(pixelObj.getGreen())+(pixelObj.getBlue()))/3;
        pixelObj.setRed(grayAverage);
        pixelObj.setGreen(grayAverage);
        pixelObj.setBlue(grayAverage);
      }
    }
  }
  ...
  public void fixUnderwater()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
    	int current= pixelObj.getRed();
        pixelObj.setRed(current*4);
      }
    }
  }
